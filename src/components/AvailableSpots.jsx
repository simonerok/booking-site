...
export default function AvailableSpotsSection({ areaData, selectedSpot, selectedArea, handleChange }) {
  console.log(areaData);
  return (
    <>
      <h2>Available Spots:</h2>
      <FormGroup className={styles.campText} labelId="dropdown-label" id="dropdowm" label="Available spots" value={selectedArea} onChange={handleChange}>
        ...
        <Select className={styles.inputField} labelId="dropdown-label" id="dropdowm" label="Available spots" value={selectedArea} onChange={handleChange}>
          {areaData.map((spot, availability) => (
